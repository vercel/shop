...
export const StaticBoundary = ({
	...
	<div
		className={`relative rounded-lg border-2 border-purple-400 bg-white p-3 dark:bg-purple-950/20 ${className ?? ""}`}
	>
...
export const DynamicBoundary = ({
	...
	<div
		tabIndex={0}
		className={`group/dynamic relative cursor-default rounded-lg border-2 border-dashed border-blue-400 bg-blue-100/70 p-2.5 outline-none transition-colors hover:bg-blue-200/60 focus-within:bg-blue-200/60 dark:bg-blue-950/20 dark:hover:bg-blue-900/30 dark:focus-within:bg-blue-900/30 ${className ?? ""}`}
	>
		<div className="absolute -top-2.5 -left-2.5">
