...
The storefront also publishes `/llms.txt`, a concise index for AI agents. It links to search, up to 50 collections, the sitemap, and crawl guidance rather than duplicating the full catalog. The [sitemap](/docs/anatomy/sitemap) remains the complete URL inventory.
...
- **Products** — brand, category, prices, options, variants, images, tags, and SEO metadata.
