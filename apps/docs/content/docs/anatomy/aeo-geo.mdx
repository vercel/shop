...
| **Sitemap**                      | Publishes a paged sitemap index for products, collections, and static pages | `app/sitemap.xml/route.ts`, `app/sitemap/[type]/[page]/route.ts`, `lib/shopify/operations/sitemap.ts` |
