...
| **Sitemap**                      | Publishes a paged sitemap index for Shopify resources and static pages | `app/sitemap.xml/route.ts`, `app/sitemap/[type]/[page]/route.ts`, `lib/shopify/operations/sitemap.ts` |
