...
The navigation system is split into a sticky top navbar for desktop and a fixed bottom bar for mobile. By default, navigation links are hardcoded. Use the [`/enable-shopify-menus`](/docs/skills/enable-shopify-menus) skill to fetch menus from Shopify and optionally add a megamenu component.
