...
- **Gift cards** — products flagged as gift cards swap the buy buttons for a recipient form (email, name, message, and optional send-on date) that schedules delivery through Shopify.
