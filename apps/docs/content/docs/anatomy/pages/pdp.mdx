...
- **Buy with Shop** - creates a Shopify checkout and redirects to it, using Shopify's official monochrome Shop Pay lock-up and the first-party button's 43 px layout per [Shopify's brand guidelines](https://help.shopify.com/en/manual/payments/shop-pay/assets)
