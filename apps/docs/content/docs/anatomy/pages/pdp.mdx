...
- **Gift cards** — collects recipient details, an optional message, and an optional delivery date. Gifts for different recipients stay separate in the cart. Recipient fields remain filled after submission; edit them before sending another gift.
