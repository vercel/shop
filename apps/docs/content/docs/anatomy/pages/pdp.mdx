...
Common additions teams build on top of the PDP. None of these ship by default — bring your own data source and component, then wire it in alongside the other sections in `product-detail-section.tsx`.
