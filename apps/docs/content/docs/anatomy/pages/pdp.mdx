...
| `components/product-detail/product-detail-page.tsx` | Server component entry point — page chrome, Suspense fallback, structured data, and the section that orchestrates media, options, pricing, and buy buttons |
