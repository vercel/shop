...
- **Buy Now** — adds the item to cart and redirects to checkout
...
| `components/product/pdp/mobile-buy-buttons.tsx` | Simplified mobile buy buttons (Buy Now + add to cart) |
