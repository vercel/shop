...
- **Buy with Shop** - creates a Shopify checkout and redirects to it, using Shopify's official full-color [Buy with Shop lock-up](https://help.shopify.com/en/manual/payments/shop-pay/assets)
