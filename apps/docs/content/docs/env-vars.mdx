...
| `SHOPIFY_CUSTOMER_ACCOUNT_URL` | Customer Account API URL. Required when using the enable-shopify-customer-accounts skill. |
| `SHOPIFY_CUSTOMER_CLIENT_ID` | Customer Account API client ID. Required when using the enable-shopify-customer-accounts skill. |
| `SHOPIFY_CUSTOMER_CLIENT_SECRET` | Customer Account API client secret. Required when using the enable-shopify-customer-accounts skill. |
