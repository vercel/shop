...
Once you're comfortable with the [agent workflow](/docs/getting-started/extending-with-agents), use these patterns to tackle common storefront customizations.
