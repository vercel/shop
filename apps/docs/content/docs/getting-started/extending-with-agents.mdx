...
- [**Cursor**](https://cursor.sh) - reads repo context and docs, but does not use the Claude plugin install flow.
- [**Codex**](https://openai.com/index/introducing-codex/) - reads repo context and docs, but does not use the Claude plugin install flow.
