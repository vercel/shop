...
Four steps get a storefront running locally: connect a Shopify store for headless access, create your project, add credentials, and start the dev server. See [Introduction](/docs/) for what the template includes and why it's built this way.
...
The default storefront needs product listings, inventory, collection listings, checkout, and content access. For the exact scope names, plus optional scopes for Shopify Auth, see [Storefront API permissions](/docs/reference/storefront-api-permissions).
...
<Cards>
  ...
  <Card title="Introduction" href="/docs/">
    What the template includes out of the box and how it's built.
  </Card>
</Cards>
