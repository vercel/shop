...
| `SHOPIFY_STOREFRONT_PASSWORD`     | Server-only Online Store password. The contact form uses it to establish a Shopify storefront session before forwarding submissions to the hosted contact handler. Never expose it publicly. |
