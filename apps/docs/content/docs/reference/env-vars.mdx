...
| Variable                   | Description                                                                                                                                                                                    |
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `NEXT_PUBLIC_ENABLE_AUTH`  | Set to `"1"` or `"0"` to override `auth.enabledByDefault`. Enabled auth requires the two Customer Authentication variables below — `next.config.ts` throws at build time if either is missing. |
