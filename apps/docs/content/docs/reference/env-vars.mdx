...
| `NEXT_PUBLIC_ENABLE_SHOPIFY_ANALYTICS` | Set to `"1"` or `"0"` to control `analytics.shopify.enabled`, which sends storefront page views to Shopify analytics. Defaults to on in development and off in production.                                                      |
