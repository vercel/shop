...
Each integration is disabled by default. Set an individual integration to `true` to render it. The root layout owns these gates and does not mount disabled integration components.
...
| `app/layout.tsx`                                       | Applies analytics and integration feature gates                        |
