...
| ------------------------------------- | ---------------- | ----------------------------------------------------------------------------------------------------------- |
| `agent.isEnabled`                     | `false`          | Shows the shopping assistant and mounts Eve's session routes. Requires the assistant environment variables. |
...
Before enabling `agent.isEnabled`, configure `AGENT_SESSION_SECRET`, `AGENT_REDIS_URL`, `AGENT_REDIS_TOKEN`, and `AGENT_STOREFRONT_URL`. Follow the [assistant setup guide](/docs/anatomy/agent); customer login is not required.
