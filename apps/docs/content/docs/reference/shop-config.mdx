...
| ------------------------------------- | ---------------- | ----------------------------------------------------------------------------------------------------- |
| `agent.isEnabled`                     | `false`          | Shows the shopping assistant and mounts Eve's session routes. Responses require AI Gateway access.    |
...
The assistant uses the existing Shopify credentials and AI Gateway access. Follow the [assistant setup guide](/docs/anatomy/agent) for the default public-session behavior; customer login is not required.
