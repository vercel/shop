...
| Resource                                | Purpose                                                               |
| --------------------------------------- | --------------------------------------------------------------------- |
| `lib/shopify/storefront.ts`             | Hydrogen `createStorefrontClient` wrapper + `customFetchApi`          |
