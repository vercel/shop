...
description: Design non-blocking data, rendering, cache, mutation, and interaction boundaries for storefront routes.
type: guide
---
...
The skill includes focused references for the shared rendering architecture, home pages, collection and search pages, product pages, and cart and account pages.

<div className="pb-6" />

{/* BEGIN SKILL CONTENT: architect-storefront */}
...
{/* END SKILL CONTENT: architect-storefront */}
