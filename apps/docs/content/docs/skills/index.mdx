...
<Cards>
  <Card title="Storefront Performance" href="/docs/skills/storefront-performance">
    Preserve rendering, streaming, media, and client-JavaScript performance while building each
    route.
  </Card>
