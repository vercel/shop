...
<Cards>
  <Card title="Build a Storefront" href="/docs/skills/build-storefront">
    Build with non-blocking data, rendering, cache, mutation, and client boundaries on every route.
  </Card>
