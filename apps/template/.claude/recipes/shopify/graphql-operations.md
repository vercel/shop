...
Keep using `.claude/schemas/shopify-storefront.graphql` as the schema source of truth,
and run `bun run .claude/scripts/fetch-shopify-schemas.ts` if the local snapshot is stale.
