...
export function FilterSidebarSheet({
  ...
  return (
    <Sheet>
      ...
      <SheetContent
        side="left"
        className="overflow-y-auto [&_[data-slot=filter-sidebar-scroll-fade]]:hidden [&_[data-slot=filter-sidebar]]:overflow-y-auto [&_[data-slot=filter-sidebar]>div]:!pb-0"
      >
