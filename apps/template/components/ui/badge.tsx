...
interface BadgeVariantProps {
  variant?: keyof typeof BADGE_VARIANTS | null;
}

function badgeVariants(
  props?: (BadgeVariantProps & { class?: ClassValue; className?: ClassValue }) | null,
) {
  ...
  return clsx(
    ...
    variant !== null && BADGE_VARIANTS[variant],
    classValue,
    className,
  );
}

interface BadgeProps extends useRender.ComponentProps<"span">, BadgeVariantProps {
