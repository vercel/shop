...
// OIDC scopes supported by Shopify Customer Account API
      ...
      config: [
        {
          ...
          // OIDC auto-discovery - endpoints are fetched from .well-known/openid-configuration
          ...
          // Shopify OIDC has no userinfo_endpoint, so we decode the ID token
          getUserInfo: async (tokens) => {
            ...
            return {
              id: decoded.sub, // Shopify Customer ID
              email: decoded.email,
