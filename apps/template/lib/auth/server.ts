...
/**
 * Cached per-request session lookup used by both lightweight and token-backed
 * auth helpers.
 */
...
/**
 * Cached per-request full session for callers that need the Shopify access
 * token in addition to the customer identity.
 */
