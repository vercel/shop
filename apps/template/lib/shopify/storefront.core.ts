...
// Next-free Storefront client. The server-only guard lives in ./storefront.ts
// (the entry the Next app imports); eve agent tools import this core directly
// because eve's standalone runtime rejects the `server-only` package.
