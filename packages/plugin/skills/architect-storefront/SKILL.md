---
name: architect-storefront
description: Architect Vercel Shop storefront routes so data loading, caching, streaming, navigation, mutations, and client interaction remain non-blocking and coherent. Use when creating, redesigning, refactoring, or reviewing the home page, product and collection pages, search, cart, account, navigation, product cards, media, loading states, or cross-route behavior; also use for decisions involving Cache Components, Suspense, Shopify data ownership, cache scope, invalidation, prefetching, Server and Client Component boundaries, layout stability, or rendering performance.
---

# Architect a Storefront
...
4. Inspect failed requests, layout shifts, LCP discovery, hydration, and interaction behavior.
5. Use the Next.js bundle analyzer when client dependencies or boundaries changed.
6. Use Speed Insights field data after deployment. Do not claim improvement from code inspection alone.
