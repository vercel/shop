...
The scaffold currently passes a catalog promise into `HomeView`. Preserve that promise boundary or replace it with smaller equivalent boundaries; do not convert the catalog read into a client fetch.
