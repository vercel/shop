...
- Run `pnpm --filter template codegen` — it validates every `#graphql` query against the schema and fails on unknown fields. Commit the regenerated types in `lib/shopify/types/generated/`.
